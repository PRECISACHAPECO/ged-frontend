...
const ThemeComponent = props => {
    ...
    const getUnreadNotifications = () => {
        setUnreadNotifications(localStorage.getItem('unreadNotifications'))
    }
    ...
    return (
        <>
            <Head>
                <title className='print-no-title'>{`GEDagro${unreadNotifications && unreadNotifications > 0 ? ` (${unreadNotifications})` : ``}`}</title>
            </Head>
